...
export default function Route() {
  return (
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        >
          <div class="flex h-16 items-center justify-between">
            ...
            >
              ...
              <a href="/account" class="font-medium text-blue-600">
                Account
              </a>
            </nav>
      ...
      >
        <div class="mb-8">
          <h1 class="mb-2 text-3xl font-bold text-slate-900">My Account</h1>
            ...
            <div class="sticky top-8 rounded-xl bg-white p-6 shadow-md">
              <div class="mb-6 text-center">
                <img
                  ...
                  alt="Profile"
                  class="mx-auto mb-4 size-20 rounded-full object-cover"
                />
              ...
              <nav class="space-y-2">
                <a
                  href="#profile"
                  class={`
                    flex items-center space-x-3 rounded-lg bg-blue-50 px-3 py-2
              ...
              <section class="rounded-xl bg-white p-6 shadow-md">
                ...
                >
                  ...
                  >
                    <button
                      class={`
                        rounded-lg bg-blue-600 px-6 py-2 font-medium text-white
                        transition-colors
                        hover:bg-blue-700
                      `}
                    >
                  ...
                  fallback={
                    <div class="space-y-4">
                      {[1, 2, 3].map(() => (
                        <div
                          class={`
                            animate-pulse rounded-lg border border-slate-200 p-4
                          `}
                        >
                          <div class="mb-4 flex items-start justify-between">
                            <div>
                              <div class="mb-2 h-4 w-32 rounded-sm bg-slate-200"></div>
                              <div class="h-3 w-24 rounded-sm bg-slate-200"></div>
                            </div>
                            <div class="h-6 w-16 rounded-sm bg-slate-200"></div>
                          </div>
                          <div class="flex items-center space-x-4">
                            <div class="size-16 rounded-lg bg-slate-200"></div>
                            <div class="flex-1">
                              <div
                                class={`mb-2 h-4 w-3/4 rounded-sm bg-slate-200`}
                              ></div>
                              <div class="h-3 w-1/2 rounded-sm bg-slate-200"></div>
                            </div>
                          </div>
                        </div>
                      ))}
                            ...
                            {order.items.map((item) => (
                              <div class="mb-4 flex items-center space-x-4">
                                <img
                                  ...
                                  alt={item.title}
                                  class={`
                                    size-16 rounded-lg bg-slate-50
                                    object-contain p-2
                                  `}
                                />
                                <div class="flex-1">
